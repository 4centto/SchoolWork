...
public class Capturista extends javax.swing.JFrame {
    ...
    public Capturista() {
        ...
        try{
            ...
            System.err.println("Error en la conexion de la interfaz Capturista" + e);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(415, 180, -1, -1));
    ...
    //Boton para imprimir la lista de clientes registrados
        ...
        try{
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    System.err.println("Error ne la informacion de los clientes");
                    JOptionPane.showMessageDialog(null, "Error en la informacion de los clientes");
                }
                
            } catch(SQLException e){
                System.err.println("Error al tomar los datos del cliente" + e);
                JOptionPane.showMessageDialog(null, "Error de conexion");
            }
