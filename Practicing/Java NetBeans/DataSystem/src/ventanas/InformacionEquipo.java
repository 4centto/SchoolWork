...
public class InformacionEquipo extends javax.swing.JFrame {
    ...
    int IDcliente_update, IDequipo = 0;
    ...
    public InformacionEquipo() {
        ...
        setTitle("Equpo del cliente " + nom_cliente + " - Sesion de " + user);
        setSize(670,530);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jTextPane_ComentarioTecnico.setEnabled(false);
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        if(validacion == 0){
            ...
            try{
                ...
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                "update equipos set tipo_equipo = ?, marca = ?, modelo = ?, num_serie = ?, observaciones = ?, "
                        + "estatus = ?, ultima_modificacion = ? where id_equipo = ?");
