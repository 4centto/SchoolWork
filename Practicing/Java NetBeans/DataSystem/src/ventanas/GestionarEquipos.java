...
public class GestionarEquipos extends javax.swing.JFrame {
    ...
    public GestionarEquipos() {
        ...
        try{
            ...
            System.err.println("Error al gestionar equipos " + e);
    ...
    private void jButton_MostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_MostrarActionPerformed
        ...
        model.setRowCount(0); // Limpieza de tabla
        model.setColumnCount(0); // Limpieza de tabla
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Error de cconexion");
        }
    ...
    private javax.swing.JButton jButton_Regsitrar1;
        ...
        jTable_equipos.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if(fila_point > -1){
                    ...
                    InformacionEquipoTecnico i = new InformacionEquipoTecnico();
                    i.setVisible(true);
